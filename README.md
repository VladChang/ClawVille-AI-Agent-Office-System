...
- `NEXT_PUBLIC_OFFICE_THEME_ASSET_BASE`：指定整組正式圖資目錄，例如 `/office/themes/succubus-showcase`
- `NEXT_PUBLIC_OFFICE_BACKGROUND_IMAGE`：覆蓋 Office 背景圖路徑
- `NEXT_PUBLIC_OFFICE_PORTRAIT_BASE_PATH`：覆蓋角色圖像目錄
- `NEXT_PUBLIC_OFFICE_PORTRAIT_EXTENSION`：角色圖檔副檔名，例如 `png`
...
7. [`docs/openclaw-live-cutover.md`](docs/openclaw-live-cutover.md)
8. [`docs/ai-prompts/official-office-assets.md`](docs/ai-prompts/official-office-assets.md)
...
- Live OpenClaw cutover：[`docs/openclaw-live-cutover.md`](docs/openclaw-live-cutover.md)
- Office AI prompts：[`docs/ai-prompts/official-office-assets.md`](docs/ai-prompts/official-office-assets.md)
